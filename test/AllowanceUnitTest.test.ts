...
describe('AllowanceUnitTest', function () {
  ...
  describe('Test Update Amount Expiration Randomly', function () {
    it('should update allowance', async function () {
      ...
      await (
        await permit2.mockUpdateAmountAndExpiration(from.address, token.address, spender.address, amount, expiration)
      ).wait()
  ...
  describe('Test Update All Randomly', function () {
    it('should update randomly', async function () {
      ...
      await (
        await permit2.mockUpdateAll(from.address, token.address, spender.address, amount, expiration, nonce)
      ).wait()
